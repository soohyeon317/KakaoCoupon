...
public class CouponApiController {
    ...
    public ResponseEntity<Coupon> createCoupon(@RequestBody Coupon.PostParam couponParam)  {
        ...
        if (couponService.isEmailExist(couponParam.getEmail())) {
            ...
            return new ResponseEntity("Unable to create. A coupon with " +
                    couponParam.getEmail() + " already exist.",HttpStatus.CONFLICT);
        }
        ...
        if(coupon == null) {
            ...
            return new ResponseEntity("Unable to create. Error occured while a coupon create.",HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    public ResponseEntity<Page<Coupon>> getCouponsByPageInfo(Coupon.GetParam pageInfo)  {
        ...
        if(coupons == null) {
            ...
            return new ResponseEntity("Unable to fetch. Error occured while fetching coupons.",HttpStatus.INTERNAL_SERVER_ERROR);
        }
